...
class UserAvailableBalance
{
    ...
    public function getAvailableBalanceID($user_id)
    {
        ...
        $trn_withdraw = Transactions::where('user_id', $user_id)->Where('transact_type', '=', 1)->Where('withdraw_source', '=', 0)->get()->sum('amount');
    ...
    public function getAvailableBalanceProfitID($user_id)
    {
        ...
        $trn_withdraw_profit = Transactions::where('user_id', $user_id)->Where('transact_type', '=', 1)->Where('withdraw_source', '=', 1)->get()->sum('amount');
    ...
    public function getAvailableBalanceReferralID($user_id)
    {
        ...
        $trn_withdraw_referral = Transactions::where('user_id', $user_id)->Where('transact_type', '=', 1)->Where('withdraw_source', '=', 2)->get()->sum('amount');
