  ...
  <div class="modal-dialog card-modal-open-m" role="document">
    <div class="modal-content card-modal-open">
      ...
      <div class=" text-center pt-1">
        <span class="modal-title text-center">Review</span>
      </div>
      <div class="modal-body">
        <span class="big-font-size px-4">Deposit Method</span><br><br> 
        ...
        <div class="deposit-res-px-5">
            ...
            @csrf
                ...
                <br>
                <div class="text-center">
                    <button type="submit" name="submit_deposit_btn" class="btn btn-primary deposit-bouty">Deposit</button>
                </div>
            </form>
        </div>
      </div>
...
@include('user.layouts.footer')
        ...
        <script>
            $('#amt-transact-input').change(function(){
                    ...
                    document.querySelector('#coin-amount-snt').value = coin_amt;
        ...
        <script>
            $('#amt-transact-input-m').change(function(){
                    ...
                    document.querySelector('#amount-snt-m').value = input_amt;
