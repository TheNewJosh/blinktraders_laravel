    ...
    <div class="modal-content card-modal-open">
      ...
      <div class="modal-body">
        ...
        <div class="deposit-res-px-5">
            <span class="big-font-size mr-2">Withdraw from</span><br>
            <div class="">
                <div class="input-withdarl withdraw_sour-m mb-1" data-value="0">
                    <label for="button-1" id="lbtn-1" class="btn text-left force-color-black force-smaller-text-m">
                        <span class="justify-space-between">
                            <sp><b>Account Balance</b> ${{$trn_sum_ava}}<br>Withdraw from your main balance</sp>
                            <sp class="force-color-green" id="spbtn-1" style="font-size:20px;"><i class="fas fa-check"></i></sp>
                        </span>
                        <input type="radio" id="button-1" name="withdraw_bal" hidden value="1" checked />
                    </label>
                </div>
                <div class="input-withdarl withdraw_sour-m mb-1" data-value="1">
                    <label for="button-2" id="lbtn-2" class="btn text-left force-color-black force-smaller-text-m">
                        <span class="justify-space-between">
                            <sp><b>Trading Profit</b> ${{$trn_sum_pro}}<br>Withdraw from your trading balance</sp>
                            <sp class="force-color-green mrda-display-none" id="spbtn-2" style="font-size:20px;"><i class="fas fa-check"></i></sp>
                        </span>
                        <input type="radio" id="button-2" name="withdraw_bal" hidden value="2" checked />
                    </label>
                </div>
                <div class="input-withdarl withdraw_sour-m mb-4" data-value="2">
                    <label for="button-3" id="lbtn-3" class="btn text-left force-color-black force-smaller-text-m">
                        <span class="justify-space-between">
                            <sp><b>Referral Earnings</b> ${{$trn_sum_ref}}<br>Withdraw from your referral earnings</sp>
                            <sp class="force-color-green mrda-display-none" id="spbtn-3" style="font-size:20px;"><i class="fas fa-check"></i></sp>
                        </span>
                        <input type="radio" id="button-3" name="withdraw_bal" hidden value="3" checked />
                    </label>
                </div>
            </div>
            <div class="text-center">
                <button type="submit" name="submit_deposit_btn" class="btn btn-primary deposit-bouty" data-toggle="modal" data-target="#exampleModalWM" data-dismiss="modal">Next</button>
            </div>
        </div>
      </div>
    </div>
...
<div class="modal fade foo" id="exampleModalWM" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog card-modal-open-m" role="document">
    <div class="modal-content card-modal-open">
      ...
      <div class="modal-body">
        <span class="big-font-size px-4">Withdrawal Method</span><br><br>
        <div class="force-color-black text-center force-small-text justify-space-between pl-5">
            <span class="ml-2">
                <img src="{{ asset('img/payment-gateway') }}/{{$payment_id->upload_icon}}" class="coin-icon" /> {{$payment_id->name}}
            </span>
        ...
        <div class="deposit-res-px-5">
            <div class="master-deposit-div-wk">
                ...
                <br>
                <div class="text-center">
                    <button type="submit" name="submit_deposit_btn" class="btn btn-primary deposit-bouty" data-toggle="modal" data-target="#myModalConfirmWithdrawInput" data-dismiss="modal">Withdraw</button>
                </div>
            </div>
        </div>
      </div>
...
-->
      ...
      <form action="{{ route('withdrawTransactStore') }}" method="post" class="modal-body text-center">
        @csrf
            ...
            <div class="row">
                <br><br>
                <div class="input-pin-stc-div" id="OTPInput">  
...
@include('user.layouts.footer')
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '#lbtn-1', function(){
                document.querySelector('#spbtn-2').classList.add("mrda-display-none");
                document.querySelector('#spbtn-3').classList.add("mrda-display-none");
                document.querySelector('#spbtn-1').classList.remove("mrda-display-none");
            });
            $(document).on('click', '#lbtn-2', function(){
                document.querySelector('#spbtn-1').classList.add("mrda-display-none");
                document.querySelector('#spbtn-3').classList.add("mrda-display-none");
                document.querySelector('#spbtn-2').classList.remove("mrda-display-none");
            });
            $(document).on('click', '#lbtn-3', function(){
                document.querySelector('#spbtn-1').classList.add("mrda-display-none");
                document.querySelector('#spbtn-2').classList.add("mrda-display-none");
                document.querySelector('#spbtn-3').classList.remove("mrda-display-none");
            });
...
for (let i = 0; i < $otp_length; i++) {
  ...
  inputField.className = "input-pin-stc";
    ...
    if (event.key === "Backspace") {
      ...
      if (inputs[i].value == '') {
        if (i != 0) {
          ...
          inputs[i-1].setAttribute("type", "number");
        }
      } else {
        inputs[i].value = '';
        inputs[i].setAttribute("type", "number");
