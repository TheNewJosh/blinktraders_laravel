  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
            ...
            <a href="{{ route('kyc') }}" class="btn btn-primary px-5">Verify Account</a>
            <br><br><br>
      </div>
    </div>
  </div>
...
<!-- The Modal trigger account not verify -->
<div class="modal" id="myModalUserBlock">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
            <span><i class="fas fa-exclamation-circle force-color-blue" style="font-size:50px;"></i></span><br><br>
            <span class="big-font-size">Account suspended.</span><br><br>
            <span>You account have been suspended for violating our policies. Please Contact support.</span><br><br>
          
            <a href="mailto:support@blinktraders.com" class="btn btn-primary">Send Mail</a>
      </div>
    </div>
  </div>
</div>
