<?php        
    ...
    if($page == "deposit-paymentgate.php" || $page == "all" || $page == "0" || $page == "1" || $page == "2"){
        $mi4 = "active-link-adm";
        $mi4_s = "show";
        $page_title = "Deposit";
        ...
        if($page == "0"){
            $mi4_l3 = "active-link-adm";
        }
        if($page == "1"){
            $mi4_l4 = "active-link-adm";
        }
        if($page == "2"){
            $mi4_l5 = "active-link-adm";
        }
    }

    if($page == "wall" || $page == "w0" || $page == "w1" || $page == "w2"){
        $mi5 = "active-link-adm";
        $mi5_s = "show";
        ...
        if($page == "w0"){
            $mi5_l2 = "active-link-adm";
        }
        if($page == "w1"){
            $mi5_l3 = "active-link-adm";
        }
        if($page == "w2"){
            $mi5_l4 = "active-link-adm";
        }
    }

    if($page == "invest-plan.php" || $page == "invest-plan-transact.php" || $page == "invest-plan-transact-comp.php"){
        $mi9 = "active-link-adm";
        $mi9_s = "show";
        ...
        if($page == "invest-plan-transact-comp.php"){
            $mi9_l3 = "active-link-adm";
        }
    }
    ...
    <div class="sidebar-link-div-adm">
        ...
        <div class="dropdown-adm <?= $mi4_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi4_s ?>" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi4_l2 ?>" href="{{ route('depositLog') }}">
                ...
                <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi4_l3 ?>" href="{{ route('depositLogStatus', ['status' => 0]) }}">
                  <i class="far fa-user mr-2"></i>
                  Pending deposits
                </a><br>
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi4_l4 ?>" href="{{ route('depositLogStatus', ['status' => 1]) }}">
                  <i class="far fa-envelope mr-2"></i>Approved deposits
                </a><br>
                <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi4_l5 ?>" href="{{ route('depositLogStatus', ['status' => 2]) }}">
        ...
        <div class="dropdown-adm <?= $mi5_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi5_s ?>" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi5_l2 ?>" href="{{ route('withdrawLogStatus', ['status' => 0]) }}">
                  <i class="far fa-envelope mr-2"></i>Unpaid withdraw
                </a><br>
                <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi5_l3 ?>" href="{{ route('withdrawLogStatus', ['status' => 1]) }}">
                  <i class="fas fa-cog mr-2"></i>
                  Approved withdraw
                </a><br>
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi5_l4 ?>" href="{{ route('withdrawLogStatus', ['status' => 2]) }}">
        ...
        <div class="dropdown-adm <?= $mi9_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi9_s ?>" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi9_l3 ?>" href="{{ route('investPlanTransactCom') }}">
        ...
        <div>
            <a href="{{ route('logout', ['user_id' => auth()->user()->id]) }}" class="py-2 px-2 link-adm">
                <span class="force-color-white mr-2"><i class="fas fa-home"></i></span>
