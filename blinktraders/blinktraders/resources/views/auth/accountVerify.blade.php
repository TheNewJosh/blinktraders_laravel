    ...
    <body>   
                                    ...
                                    <div class="px-2">
                                        <form action="{{ route('accountVerify') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="verify_code" class="form-control input-outline" value="{{ old('verify_code') }}" required>
                                                @error('verify_code')
        ...
        <script>            
            @if(session('statusError'))
                window.onload = (event) => {
                bs4pop.notice('Error Occur: Wrong Code', {position: 'topright', type: 'danger'})
                };
            @endif
