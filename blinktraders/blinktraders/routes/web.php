...
Route::get('/logout/{user_id}/session', [LogoutController::class, 'store'])->name('logout');
...
Route::get('/withdrawTransactCode/{transactions_id}/Transact/{charge}/copycode', [WithdrawController::class, 'code'])->name('withdrawTransactCode');
...
Route::post('/depositPaymentgateUpdateCoin', [DepositPaymentgateController::class, 'updateCoinPrice'])->name('depositPaymentgateUpdateCoin');
...
Route::get('/depositLogStatus/{status}/status', [DepositLogController::class, 'status'])->name('depositLogStatus');
...
Route::get('/withdrawLogStatus/{status}/status', [WithdrawLogController::class, 'status'])->name('withdrawLogStatus');
...
Route::get('/investPlanTransactCom', [InvestPlanTransactionController::class, 'completed'])->name('investPlanTransactCom');
